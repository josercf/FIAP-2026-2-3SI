...
//
// GABARITO do professor: versao completa do esqueleto em http-l7/server.js.
// Nao distribuir junto com o Lab Kit dos alunos.
//
// Para testar este gabarito no lugar do esqueleto:
//   cp gabarito/server.js http-l7/server.js && node http-l7/server.js
...
const PAGINA_PAINEL = path.join(__dirname, '..', 'http-l7', 'public', 'index.html');
...
const servidor = http.createServer((req, res) => {
  ...
  // 405 antes de tudo: a rota existe, o metodo e que nao serve.
  ...
  if (rota === '/api/v1/eventos') {
    ...
    // sem esperar a proxima posicao chegar.
    ...
    // Heartbeat: comentario SSE que mantem a conexao viva atras de proxies
