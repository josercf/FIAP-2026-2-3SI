...
//
// ESTE ARQUIVO E SEU. E a lacuna TODO-4 do laboratorio.
//
...
// ---------------------------------------------------------------------------
// TODO-4: as duas decisoes
// ---------------------------------------------------------------------------

/**
 * TODO-4a: devolva os papeis do token, lidos de `realm_access.roles`.
 *
 * Contrato:
...
export function papeisDoToken(conteudo) {
  // Dica: `conteudo?.realm_access?.roles` pode ser undefined, pode nao ser
  // array, e o retorno precisa ser um array de strings em qualquer caso.
  return []; // TODO-4a
}

/**
 * TODO-4b: o portao deste servico.
 *
...
export async function guarda(metodo, caminho, authorization) {
  // TODO-4b
  throw new NaoAutenticado('TODO-4 ainda nao implementado em seguranca.mjs');
}
